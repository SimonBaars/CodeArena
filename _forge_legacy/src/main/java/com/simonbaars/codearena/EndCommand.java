...
public class EndCommand implements ICommand, FormatsText {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		if(c.getArena() == null)
			sender.sendMessage(FormatsText.format(net.minecraft.util.text.TextFormatting.RED, "There is no Code Arena running"));
