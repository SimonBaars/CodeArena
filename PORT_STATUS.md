...
Updated: 2026-09-05 ~7:25 PM PT — post `d38530c` + `dd76f99` (JavaParser AST + `/codearena scan`).
...
| Playable core | Schematic `arena` + corner `watchtower`s; `/codearena spawn\|scan\|end\|problems\|place`; 8 smell entity types; spider/cave-spider skins; package diamonds; sidebar score |
