package com.simonbaars.codearena.monster.codecreeper;
...
{
    private static final DataParameter<Integer> STATE = EntityDataManager.<Integer>createKey(EntityCodeCreeper.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> POWERED = EntityDataManager.<Boolean>createKey(EntityCodeCreeper.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> IGNITED = EntityDataManager.<Boolean>createKey(EntityCodeCreeper.class, DataSerializers.BOOLEAN);
    /**
    ...
    public EntityCodeCreeper(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityCodeCreeper.class);
    }
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (this.world.getGameRules().getBoolean("doMobLoot"))
        {
            ...
            else if (cause.getTrueSource() instanceof EntityCodeCreeper && cause.getTrueSource() != this && ((EntityCodeCreeper)cause.getTrueSource()).getPowered() && ((EntityCodeCreeper)cause.getTrueSource()).ableToCauseSkullDrop())
            {
                ((EntityCodeCreeper)cause.getTrueSource()).incrementDroppedSkulls();
