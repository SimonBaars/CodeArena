...
public class LayerCodeSpiderEyes<T extends EntityCodeSpider> implements LayerRenderer<T>
{
    private static final ResourceLocation SPIDER_EYES = new ResourceLocation("textures/entity/spider_eyes.png");
    private final RenderCodeSpider<T> spiderRenderer;

    public LayerCodeSpiderEyes(RenderCodeSpider<T> spiderRendererIn)
    {
